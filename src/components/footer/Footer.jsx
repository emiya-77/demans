...
const Footer = () => {
  return (
    <div>
      <div className={`${dm_serif_display.className} border-b-[1px] border-black pb-8 2xl:h-[287px] md:mt-20 xl:mt-[156px]`}>
      ...
      <div className="flex justify-center items-center h-[54px]">
        <p className="text-[#5c5b5b] text-[15px] text-center">Copyright © 2024 <span className="font-medium">Solutya Pvt. Ltd.</span> All Rights Reserved. <span className="font-medium">|</span> Developed By <span className="font-medium">Solutya Pvt. Limited.</span></p>
      </div>
    </div>
  )
}
