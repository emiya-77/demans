...
const NewsLetter = () => {
    return (
        <div className={`font-primary h-[458px] flex flex-col md:flex-row items-center gap-2 md:gap-7 mt-40 mb-20`}>
            ...
            <div className="w-full md:w-1/3 h-full flex justify-center items-start">
                <div className="w-[300px] h-[300px] md:w-[410px] md:h-[410px] bg-gray-300">
                </div>
            </div>
            <div className="w-full md:w-2/3 text-center md:text-start">
                ...
                <div className="flex justify-center gap-5">
                    <input type="text" className="w-[650px] bg-transparent border-b-[1px]" />
