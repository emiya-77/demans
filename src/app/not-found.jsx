...
const NotFound = () => {
  return (
    <div className="">
      <div className="h-[480px] md:h-[500px] 2xl:h-[680px] -z-10 absolute left-0 right-0 top-28 bottom-0 bg-[#B0B0B0]"
      style={{
        backgroundImage: `url(${img404?.src})`,
        backgroundSize: 'cover',
        backgroundPosition: 'center',
      }}></div>
      <div className="absolute w-full left-0 right-0 top-28 h-[480px] md:h-[500px] 2xl:h-[680px] bg-black opacity-20">

      </div>
      <div className="w-full flex justify-center items-center h-[480px] 2xl:h-[700px] 2xl:-mt-10 mb-20 xl:mb-0">
