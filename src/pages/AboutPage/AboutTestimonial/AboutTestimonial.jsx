...
const AboutTestimonial = () => {
  return (
    <div className="flex justify-center items-center h-[305px] my-10 px-6 gap-12">
        <div className="w-1/2 h-full bg-[#7E7E7E] flex justify-center items-center">
            <div className="w-full py-6 px-8 space-y-6">
                ...
                <h3 className="font-primary text-white text-[24px] leading-[30px]">
