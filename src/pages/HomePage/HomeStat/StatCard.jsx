...
const StatCard = ({info}) => {
  ...
  return (
    <div className="flex w-[180px] md:w-[201px] justify-center items-center">
        <div className="w-full lg:-mt-14">
            ...
            <h2 className="text-[16px] md:text-[24px] text-center text-white line-clamp-2 md:line-clamp-none">
                {content}
            </h2>
        </div>
    </div>
