...
const Banner = () => {
  ...
  return (
    <>
        <div className="h-[480px] 2xl:h-[780px] z-0 absolute left-0 right-0 bg-[#B0B0B0]"></div>
        <div className={`h-[480px] 2xl:h-[780px] relative z-10 flex justify-start items-end pb-28`}>
