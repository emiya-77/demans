...
const MovementAction = ({info = aboutInfo, img}) => {
    ...
    return (
        <div className={`font-primary w-full h-[1024px] xl:h-[630px] 2xl:h-[420px]`}>
            <div className="h-full flex flex-col xl:flex-row justify-center items-center gap-12 xl:gap-[30px]">
                ...
                <div className="relative w-full bg-[#EDEDED] xl:w-[630px] h-[30%] md:h-[40%] lg:h-[70%] 2xl:h-full shadow-lg">
